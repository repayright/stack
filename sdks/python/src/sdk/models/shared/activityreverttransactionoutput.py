...
class ActivityRevertTransactionOutputScript:
...
class ActivityRevertTransactionOutput:
    ...
    script: Optional[ActivityRevertTransactionOutputScript] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('script'), 'exclude': lambda f: f is None }})
