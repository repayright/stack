...
class ActivityCreateTransactionOutputScript:
...
class ActivityCreateTransactionOutput:
    ...
    script: Optional[ActivityCreateTransactionOutputScript] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('script'), 'exclude': lambda f: f is None }})
