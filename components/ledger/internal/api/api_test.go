...
import (
	...
	controllers "github.com/formancehq/ledger/internal/api"
	ledger "github.com/formancehq/ledger/internal/engine"
...
func (m *MockLedger) GetAccountsWithVolumes(ctx context.Context, query ledgerstore.GetAccountsQuery) (*api.Cursor[internal.ExpandedAccount], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountsWithVolumes", ctx, query)
	ret0, _ := ret[0].(*api.Cursor[internal.ExpandedAccount])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockLedger) GetLogs(ctx context.Context, query ledgerstore.GetLogsQuery) (*api.Cursor[internal.ChainedLog], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLogs", ctx, query)
	ret0, _ := ret[0].(*api.Cursor[internal.ChainedLog])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockLedger) GetTransactions(ctx context.Context, query ledgerstore.GetTransactionsQuery) (*api.Cursor[internal.ExpandedTransaction], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransactions", ctx, query)
	ret0, _ := ret[0].(*api.Cursor[internal.ExpandedTransaction])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
